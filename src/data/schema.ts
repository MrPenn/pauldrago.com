...
export const PERSON = {
  ...
  description: 'Paul Drago advises banks and credit unions on marketing measurement, market decisions, and the operating work behind growth. He spent eight years in digital and marketing at a community bank holding company.',
  worksFor: { '@id': ORG_ID },
...
export const ORGANIZATION = {
  ...
  url: `${SITE}/`,
  email: 'mailto:paul@pauldrago.com',
  description: "Glass Vase, LLC is Paul Drago's advisory company. It provides marketing measurement, market and acquisition analysis, and fractional marketing leadership to banks and credit unions.",
...
export const WEBSITE = {
  ...
  url: `${SITE}/`,
  name: 'Paul Drago',
  description: 'Marketing measurement, market analysis, and fractional marketing leadership for banks and credit unions.',
  inLanguage: 'en-US',
  publisher: { '@id': ORG_ID },
  author: { '@id': PERSON_ID },
};
